...
void st7735_drawchar_x6(unsigned char x,unsigned char y,char chr,uint16_t color, uint16_t bg_color);
void st7735_string_x3_at(unsigned char x,unsigned char y, unsigned char *chr, uint16_t color, uint16_t bg_color);
void st7735_string_x6_at(unsigned char x,unsigned char y, unsigned char *chr, uint16_t color, uint16_t bg_color);
